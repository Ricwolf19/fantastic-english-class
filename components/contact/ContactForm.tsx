...
/**
 * Formulario de contacto (client). Ejecuta reCAPTCHA v3 antes de enviar al
 * server action, muestra errores por campo y un estado de éxito reutilizable.
 */
export const ContactForm = () => {
  ...
  if (sent) {
    return (
      <div
        role="status"
        className="rounded-card border-brand/30 bg-brand/12 border p-8 text-center"
      >
        ...
        <button
          ...
          className="text-brand mt-3 text-sm font-medium hover:underline"
        >
    ...
    <form onSubmit={onSubmit} className="space-y-4" noValidate>
      ...
      <p className="text-ink-500 text-xs leading-relaxed">
        ...
        <a
          ...
          className="hover:text-ink-300 underline"
        >
